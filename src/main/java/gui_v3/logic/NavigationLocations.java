...
public enum NavigationLocations {
    HOME, ENTRIES, ITEMS, ITEMS_AUTO_DETECT_PT1, ITEMS_AUTO_DETECT_PT2, ITEMS_MANUAL_PT1, ITEMS_MANUAL_PT2, ITEMS_MANUAL_PT3, FILTER, WINNERS;
    ...
    public static boolean isItemLocation(NavigationLocations location) {
        return (location == ITEMS) || (location == ITEMS_AUTO_DETECT_PT1) || (location == ITEMS_AUTO_DETECT_PT2)
                || (location ==  ITEMS_MANUAL_PT1) || (location == ITEMS_MANUAL_PT2) || (location == ITEMS_MANUAL_PT3);
    }
}
