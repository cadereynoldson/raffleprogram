...
public class ItemsPanel extends JPanel implements FadeCapable, FadingComponent, PropertyChangeListener {
    ...
    /**
     * Sets the current items mode according to the values in the raffle gui_v2.logic of this panel.
     * @param logic the gui_v2.logic to set the current mode according to.
     */
